...
def generate_prompt(category_name: str):
    return f"""Q: What are visual details for distinguishing a lemur in a photo?
A: There are several useful visual details of a lemur in a photo:
- four-limbed primate
...
Q: What are visual details for distinguishing a television in a photo?
A: There are several useful visual details of a television in a photo:
- electronic device
- black or grey
...
def generate_prompt_noshots(category_name):
    return f"""Q: What are visual details for distinguishing a {category_name} in a photo?
A: There are several useful visual details of a {category_name} in a photo:
- a"""
